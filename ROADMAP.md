...
What's shipped in v0.3, and what's next. Each unshipped item is a ready contribution slot: copy the
...
## Shipped in v0.3 (the complete stack)
...
- **Skills (25)**, every one with a `references/` folder:
...
- **Prompts**: the full library, 26 standalone copy-paste prompts (one per skill, plus a Remove-the-AI test prompt), tool-tagged. ✅
